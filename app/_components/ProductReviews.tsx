...
import ReviewMediaUpload, {
  ReviewMediaUploadRef,
} from "@/components/ReviewMediaUpload";
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await fetch(
        `/api/products/${product._id}/reviews?reviewId=${reviewToDelete._id}`,
        {
          method: "DELETE",
          credentials: "include",
        }
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            <p className="text-sm text-foreground">
              Are you sure you want to delete your review? This will permanently
              remove your review and rating from this product.
            </p>
          </div>
