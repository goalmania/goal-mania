        ...
        <div className="relative pb-16">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-10 flex items-center gap-4">
            <button
              ...
              className="rest-world-prev flex items-center justify-center w-10 h-10 rounded-full bg-[#D9D9D9] shadow-md hover:bg-[#111]"
            >
            ...
            <button
              ...
              className="rest-world-next flex items-center justify-center w-10 h-10 rounded-full bg-[#D9D9D9] shadow-md hover:bg-[#111]"
            >
              <svg className="w-5 h-5 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
