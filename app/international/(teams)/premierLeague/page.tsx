...
import { Trophy, Calendar, Newspaper, TrendingUp } from "lucide-react";
        ...
        <div className="relative container mx-auto px-4 py-12 md:py-20">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto animate-in slide-in-from-bottom-4 duration-700 delay-200">
              Scopri le ultime notizie, il calendario delle partite e le statistiche della più prestigiosa lega calcistica del mondo
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 animate-in slide-in-from-bottom-4 duration-700 delay-400">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-[#0e1924]">10</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-4 duration-700 delay-800">
              ...
              <div className="p-4 space-y-3">
                <a href="/shop/international" className="flex items-center justify-between p-3 rounded-lg bg-gray-50 hover:bg-[#f5963c]/10 transition-colors duration-200 group">
                  <span className="font-medium text-[#0e1924] group-hover:text-[#f5963c]">Maglie Premier League</span>
