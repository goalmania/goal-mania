...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("HEY WEBHOOK: ", payment);
    ...
    // const orderDetails = await OrderDetails.findOne({ paymentIntentId: payment.id });
    // if (!orderDetails) {
    ...
    //     processed.customization.selectedPatches = processed.customization.selectedPatches.map(
    //       (patch: any) => {
