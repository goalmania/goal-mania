      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-20 pt-12 pb-12">
        ...
        <div className="max-w-4xl mx-auto bg-[#0a0a0a] rounded-2xl shadow-xl p-8">
          <div className="prose prose-lg max-w-none">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">1. Information We Collect</h2>
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">2. How We Use Your Information</h2>
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">3. Information Sharing</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">4. Data Security</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">5. Cookies and Tracking</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">6. Your Rights (GDPR)</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">7. Data Retention</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">8. International Transfers</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">9. Children's Privacy</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">10. Changes to This Policy</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#0a0a0a] mb-4">11. Contact Information</h2>
              <p className="text-white/70 mb-4">
