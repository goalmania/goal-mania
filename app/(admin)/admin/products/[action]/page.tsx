    ...
    const fetchCategories = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('[Product Form] Fetched categories:', data);
          ...
          console.log('[Product Form] Active categories:', activeCategories);
          setDynamicCategories(activeCategories);
        } else {
          console.error('[Product Form] Failed to fetch categories:', response.status, response.statusText);
        }
      } catch (error) {
