...
export default function FlashSaleSection({ product }: Props) {
  ...
  const fullTitle = product ? cleanTitle(product.name) : "Maglia in Evidenza";
  const price = product?.price ?? 79.9;

  // Split title: last word accented in lime
    ...
    <section className="py-12 md:py-16 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          <span
            className="w-6 h-[1.5px] rounded-full inline-block"
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 28% 50%, rgba(200,240,0,0.07) 0%, transparent 60%)",
            }}
          />
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-stretch">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at center, rgba(200,240,0,0.1) 0%, transparent 65%)",
                }}
              />
                    ...
                    {[pad(minutes), ":", pad(seconds)].map((part, i) => (
                      <span
                        ...
                        className={`font-black text-base ${
                          part === ":" ? "" : "px-2 py-1 rounded-lg"
                        }`}
                        style={{
                          fontFamily: "var(--font-mono, monospace)",
                          color: "#c8f000",
                          background:
                            part !== ":" ? "rgba(200,240,0,0.1)" : "transparent",
                          border:
                            part !== ":"
                              ? "1px solid rgba(200,240,0,0.15)"
                              : "none",
                        }}
                      >
                        {part}
