  ...
  return (
    <section className="relative h-screen bg-[#0e1924] text-white flex flex-col items-center justify-center py-16 px-4">
      <div className="w-full max-w-4xl text-center flex flex-col items-center">
        ...
        {/* Smaller BannerBlock(s) for CTA below hero text */}
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8">
          <BannerBlock imageSrc="/banners/banner_1.jpeg" ctaHref="/shop" className="max-w-xs w-full bg-transparent shadow-none" />
          <BannerBlock imageSrc="/banners/banner_2.jpeg" ctaHref="/shop" className="max-w-xs w-full bg-transparent shadow-none" />
        </div>
      </div>
    </section>
  );
